...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/advert/advert/">广告列表</a></li>
    <li class="active">
        <a href="${ctx}/advert/advert/form?id=${advert.id}">广告
            <shiro:hasPermission name="advert:advert:edit">${not empty advert.id?'修改':'添加'}  </shiro:hasPermission>
            <shiro:lacksPermission name="advert:advert:edit">查看</shiro:lacksPermission>
        </a>
    </li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="advert" action="${ctx}/advert/advert/save" method="post"
    ...
    <div class="form-actions">
        <shiro:hasPermission name="advert:advert:edit">
            <c:choose>
                <c:when test="${empty advert.status}">
